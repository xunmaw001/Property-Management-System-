...
import com.entity.FangyuanCollectionEntity;
...
public class FangyuanCollectionView extends FangyuanCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String fangyuanCollectionValue;
	...
	public FangyuanCollectionView() {

	}

	public FangyuanCollectionView(FangyuanCollectionEntity fangyuanCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, fangyuanCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getFangyuanCollectionValue() {
				return fangyuanCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setFangyuanCollectionValue(String fangyuanCollectionValue) {
				this.fangyuanCollectionValue = fangyuanCollectionValue;
			}
