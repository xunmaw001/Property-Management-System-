...
var centerMenu = [
    ...
    ,{
        name: '房源收藏',
        url: '../fangyuanCollection/list.html'
    }
...
var adminurl =  "http://localhost:8080/fangyuanguanli/admin/dist/index.html#/login";
